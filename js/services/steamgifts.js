...
( ( wishlist && _this.getConfig('ignore_on_wish') ) || _this.getConfig('min_level') === 0 || level >= _this.getConfig('min_level') ) &&
( ( wishlist && _this.getConfig('ignore_on_wish') ) || _this.getConfig('max_cost') === 0 || cost <= _this.getConfig('max_cost') ) &&
( ( wishlist && _this.getConfig('reserve_on_wish') ) || _this.getConfig('points_reserve') === 0 || ( (_this.curr_value - cost) >= _this.getConfig('points_reserve') ) )
)
{
$.ajax({
